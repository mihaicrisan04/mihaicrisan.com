  ...
  return (
    <div className={cn("space-y-0", className)}>
      {childrenArray.map((child, index) => {
        // Children from React.Children.toArray() already have stable keys
        // We use baseId + index to create unique keys for the Fragment wrapper
        const fragmentKey = `${baseId}-step-${index}`;
        return (
