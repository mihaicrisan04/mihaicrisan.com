...
// Static arrays with unique IDs to avoid noArrayIndexKey lint errors
const SPINNER_BARS = Array.from({ length: 12 }, (_, i) => `spinner-${i}`);
const DOTS_3 = ["dot-0", "dot-1", "dot-2"];
const WAVE_BARS_5 = ["wave-0", "wave-1", "wave-2", "wave-3", "wave-4"];
...
export function ClassicLoader({
  ...
  const marginLeftValues = { sm: "-0.75px", md: "-1px", lg: "-1.25px" };
  const originX = { sm: "0.75px", md: "1px", lg: "1.25px" };
  const originY = { sm: "10px", md: "12px", lg: "14px" };

  return (
    <div className={cn("relative", sizeClasses[size], className)}>
      <div className="absolute h-full w-full">
        {SPINNER_BARS.map((id, i) => (
          <div
            ...
            style={{
              top: "0",
              left: "50%",
              marginLeft: marginLeftValues[size],
              transformOrigin: `${originX[size]} ${originY[size]}`,
